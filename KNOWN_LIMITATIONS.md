...
- Automated unit tests (27 files / 139 tests), typecheck, lint and build pass locally, but full E2E smoke coverage still depends on installing Playwright browsers in the environment.
