...
- Automated unit tests (26 files / 138 tests), typecheck, lint and build pass locally, but full E2E smoke coverage still depends on installing Playwright browsers in the environment.
