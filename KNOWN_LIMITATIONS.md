...
- Campaign/zrzutka/crowdfunding/fundraising is out of private beta scope; no campaign page is shipped. Stripe remains only as a voluntary tip / Patron payment flow.
...
- Automated unit tests (32 files / 151 tests), typecheck and lint pass locally; full E2E smoke coverage still depends on installing Playwright browsers in the environment, and production build requires real Clerk public env.
