...
Repo nadal ma funkcje oznaczone jako eksperymentalne lub niedomknięte: upload/transcoding pipeline, signed HLS/DASH delivery oraz future multi-creator architecture. Campaign/zrzutka/crowdfunding nie jest funkcją do domknięcia w becie — jest poza zakresem produktu prywatnej bety.

- [ ] Spisać jawny beta scope: które funkcje są w becie, które są wyłączone/ukryte i które są świadomie poza zakresem.
- [ ] Remove campaign/zrzutka/crowdfunding scope from beta product.
