...
async function fix() {
  ...
  const commands = [
    ...
    `ALTER TABLE "Video" ADD COLUMN IF NOT EXISTS "showInSidebar" BOOLEAN DEFAULT true;`,
    `ALTER TABLE "Video" ADD COLUMN IF NOT EXISTS "sidebarOrder" INTEGER DEFAULT 0;`,
