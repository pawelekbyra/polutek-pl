...
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || 'Kraufanding';
export const APP_DOMAIN = process.env.NEXT_PUBLIC_APP_URL ? new URL(process.env.NEXT_PUBLIC_APP_URL).hostname.toUpperCase() : 'KRAUFANDING';
