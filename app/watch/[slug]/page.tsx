...
export default async function LegacyWatchRedirect(props: { params: Promise<{ slug: string }>; searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  redirect(appendQueryString(getLocalizedHref(locale, "watch", { slug }), query));
}
