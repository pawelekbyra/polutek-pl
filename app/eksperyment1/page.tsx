...
export const metadata = {
  title: "Eksperyment 1 — Polutek.pl",
  description: "Pierwsza dopracowana koncepcja strony Polutek.pl: spokojny, premium, editorialny styl VOD.",
};

export default function ExperimentOnePage() {
  return (
    <main className="min-h-[100dvh] overflow-hidden bg-[#f8f3e7] text-zinc-950">
      <section className="relative isolate px-5 py-6 sm:px-8 lg:px-12">
        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between rounded-full border border-zinc-950/10 bg-[#fffaf0]/80 px-4 py-3 shadow-[0_18px_70px_rgba(23,23,23,.08)] backdrop-blur">
          <Link href="/" className="font-brand text-lg font-black tracking-tight">POLUTEK</Link>
          ...
          <Link href="/eksperyment2" className="rounded-full bg-zinc-950 px-4 py-2 text-sm font-bold text-[#f8f3e7] transition hover:bg-blue-600">
            Wersja 2
          </Link>
        </nav>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 pb-16 pt-14 lg:grid-cols-[1.04fr_.96fr] lg:items-center lg:pb-24 lg:pt-20">
          <div>
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-600/20 bg-white/70 px-3 py-2 text-sm font-bold text-blue-700 shadow-sm">
              <Sparkles className="h-4 w-4" /> Autorski kanał wideo, bez algorytmicznego hałasu
            </div>
            <h1 className="max-w-4xl text-balance font-heading text-5xl font-black leading-[0.95] tracking-[-0.055em] sm:text-7xl lg:text-8xl">
              Kino dla jednej społeczności. Z charakterem papieru i ostrością ekranu.
            </h1>
            <p className="mt-7 max-w-2xl text-pretty text-lg leading-8 text-zinc-700 sm:text-xl">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <a href="#kolekcja" className="group inline-flex items-center justify-center rounded-full bg-blue-600 px-6 py-4 text-base font-black text-white shadow-[0_18px_45px_rgba(37,99,235,.28)] transition hover:-translate-y-0.5 hover:bg-blue-700">
                Zobacz układ strony <ArrowRight className="ml-2 h-5 w-5 transition group-hover:translate-x-1" />
              </a>
              <Link href="/" className="inline-flex items-center justify-center rounded-full border border-zinc-950/15 bg-white/65 px-6 py-4 text-base font-black text-zinc-950 transition hover:bg-white">
                Powrót do serwisu
              </Link>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="rounded-[2rem] border border-zinc-950/10 bg-zinc-950 p-3 shadow-[0_35px_100px_rgba(23,23,23,.22)]">
              <div className="overflow-hidden rounded-[1.55rem] bg-[#111]">
                <div className="relative aspect-video bg-[radial-gradient(circle_at_30%_20%,rgba(37,99,235,.85),transparent_28%),linear-gradient(135deg,#18181b,#050505_70%)]">
                  <div className="absolute inset-5 rounded-3xl border border-white/10" />
                  <button className="absolute left-1/2 top-1/2 grid h-20 w-20 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full bg-white text-zinc-950 shadow-2xl">
                  ...
                  <div className="absolute bottom-5 left-5 right-5 flex items-end justify-between text-white">
                    ...
                    <span className="rounded-full bg-white/12 px-3 py-1 text-sm font-bold backdrop-blur">4K Ready</span>
                  </div>
                </div>
                <div className="grid gap-2 bg-[#f8f3e7] p-4">
                  {episodes.map((episode) => (
                    <div key={episode.title} className="flex items-center gap-3 rounded-2xl border border-zinc-950/10 bg-white/70 p-3">
      ...
      <section id="kolekcja" className="px-5 pb-20 sm:px-8 lg:px-12">
        <div className="mx-auto grid max-w-7xl gap-5 lg:grid-cols-3">
          {features.map((feature) => (
            <div key={feature} className="rounded-[1.75rem] border border-zinc-950/10 bg-white/55 p-7 shadow-[0_18px_60px_rgba(23,23,23,.07)] backdrop-blur">
      ...
      <section id="patron" className="px-5 pb-20 sm:px-8 lg:px-12">
        <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[2rem] border border-zinc-950/10 bg-zinc-950 text-white shadow-[0_35px_90px_rgba(23,23,23,.22)] lg:grid-cols-[.9fr_1.1fr]">
          ...
          <div className="bg-white p-8 text-zinc-950 sm:p-10 lg:p-12">
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                <div key={k} className="rounded-3xl border border-zinc-950/10 bg-[#f8f3e7] p-5">
      ...
      <section id="manifest" className="px-5 pb-16 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-7xl rounded-[2rem] border border-zinc-950/10 bg-[#fffaf0]/75 p-8 text-center shadow-[0_18px_70px_rgba(23,23,23,.08)] sm:p-12">
