  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] text-[#1a1a1a] font-serif leading-relaxed">
      ...
      <main className="max-w-3xl mx-auto px-4 py-16">
        <h1 className="text-3xl font-black uppercase tracking-tighter mb-12 border-b-2 border-[#1a1a1a]/10 pb-8">Regulamin Serwisu Paweł Perfect</h1>
        <div className="prose prose-md prose-neutral space-y-8 text-[#1a1a1a]">
          <section>
            ...
            <p>
              Serwis Paweł Perfect jest prywatną, autorską platformą wideo.
          ...
          <section>
            ...
            <p>
              Wszelkie wpłaty są procesowane przez Stripe i mają charakter bezzwrotny. Dokonując wpłaty, użytkownik wspiera rozwój projektów autora
