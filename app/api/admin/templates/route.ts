...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json(template || {
        name: 'WELCOME',
        subjectPl: 'Witaj u Paweł Perfect!',
        bodyPl: `
          <div style="font-family: serif; color: #1a1a1a; background-color: #FDFBF7; padding: 40px; line-height: 1.6; border: 1px solid #1a1a1a;">
            <h1 style="text-transform: uppercase; letter-spacing: -0.05em; border-bottom: 2px solid #1a1a1a; padding-bottom: 16px;">Witaj u Paweł Perfect</h1>
            <p>Cześć!</p>
            ...
            <p>Odwiedź stronę, aby zobaczyć najnowsze filmy.</p>
            <br />
            <p style="font-style: italic; border-top: 1px solid #1a1a1a; padding-top: 16px;">Pozdrawiamy,<br />Zespół Paweł Perfect</p>
          </div>
        `,
        subjectEn: 'Welcome to Paweł Perfect!',
        bodyEn: `
          <div style="font-family: serif; color: #1a1a1a; background-color: #FDFBF7; padding: 40px; line-height: 1.6; border: 1px solid #1a1a1a;">
            <h1 style="text-transform: uppercase; letter-spacing: -0.05em; border-bottom: 2px solid #1a1a1a; padding-bottom: 16px;">Welcome to Paweł Perfect</h1>
            <p>Hello!</p>
            ...
            <p>Visit the platform to see the latest videos.</p>
            <br />
            <p style="font-style: italic; border-top: 1px solid #1a1a1a; padding-top: 16px;">Best regards,<br />Paweł Perfect Team</p>
          </div>
        `
    });
  } catch (err) {
