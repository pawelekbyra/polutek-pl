  ...
  return (
    <div className="experiment15-skin">
      ...
      <style jsx global>{`
        ...
        .exp15-gallery [class*="bg-background"],
        .exp15-gallery .bg-secondary {
        ...
        .exp15-gallery .border-neutral-300 {
          border-color: rgba(31, 33, 31, .18) !important;
        }

        .exp15-gallery [class*="shadow"] {
        ...
        .exp15-gallery section.bg-transparent [class*="rounded"] {
        ...
        .exp15-gallery [class*="bg-black"] {
          background-color: rgba(31, 33, 31, .64) !important;
        }
        ...
        .exp15-gallery aside a > div:first-child {
          border-radius: 2px !important;
          filter: saturate(.90) contrast(1.02);
        }

        .exp15-gallery div[class*="rounded"],
