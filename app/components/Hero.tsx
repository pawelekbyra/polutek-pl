...
const Hero: React.FC<HeroProps> = ({ video, initialInteraction, initialIsSubscribed }) => {
  ...
  return (
    <section className="bg-transparent">
      <div className="w-full rounded-[var(--chan-radius-xl)] border border-[var(--chan-line)] bg-[color-mix(in_srgb,var(--chan-card)_86%,white)] p-2.5 shadow-[var(--chan-shadow-lg)] md:p-3">
        {/* FEATURED MEDIA */}
        <div className="relative mb-4 aspect-video w-full overflow-hidden rounded-[var(--chan-radius-lg)] bg-black md:rounded-[var(--chan-radius-xl)]">
        ...
        <div className="space-y-3 px-1 pb-1 md:px-2">
          ...
          <div className={cn("flex flex-col justify-between gap-2 lg:flex-row lg:items-center", styles.metaRow)}>
            ...
            <div className={cn("flex w-full flex-wrap items-center gap-2 lg:w-auto lg:flex-nowrap", styles.actionRail)}>
               <div className={cn("relative flex h-[42px] shrink-0 items-center rounded-[var(--chan-radius-md)] bg-[var(--chan-surface)]", styles.actionCluster)}>
                  <button
                    onClick={handleLike}
                    disabled={isPending}
                    className={cn(
        ...
        {/* DESCRIPTION PANEL */}
        <div
          className={cn("mt-2 cursor-pointer rounded-[var(--chan-radius-lg)] border px-4 pt-[9px] pb-3 transition-colors hover:border-[#2563eb]/40 md:px-5", styles.descPanel)}
