...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center bg-slate-900 sticky top-0 z-50 border-b border-slate-800 px-4 lg:px-6 h-14 min-h-14 font-sans justify-between gap-2 md:gap-4 w-full max-w-full overflow-hidden">
      {isMobileSearchOpen ? (
