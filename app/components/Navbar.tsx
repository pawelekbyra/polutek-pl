            ...
            <div className="flex shrink-0 items-center justify-end gap-1.5 md:gap-2">
              ...
              {isLoaded && !isSignedIn && (
                <button
                  ...
                  className="flex h-10 items-center justify-center gap-2 rounded-[12px] px-2 sm:px-3 shrink-0 font-sans text-[var(--chan-ink)] transition-all hover:-translate-y-px hover:bg-[var(--chan-surface)] active:scale-95"
                  aria-label={t.signIn}
                  title={t.signIn}
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--chan-ink)] shrink-0" aria-hidden="true">
                    <path d="M15 4H8a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h7" />
                    <path d="M11 12h9m0 0-3.5-3.5M20 12l-3.5 3.5" />
                  </svg>
                  <span className="hidden sm:inline text-[14px] font-semibold text-[var(--chan-ink)]">{t.signIn}</span>
                </button>
              )}
