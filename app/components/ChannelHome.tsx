      ...
      <div className="mx-auto max-w-[1180px] px-4 pb-8 pt-4 md:px-6 lg:px-8 lg:pb-10 lg:pt-5">
        <div className="grid grid-cols-12 gap-5 lg:items-start xl:gap-6">
          <div className="col-span-12 flex flex-col lg:col-span-8">
            ...
            <div
              className={cn(
                "mt-3 rounded-[22px] border border-[var(--cm-line-80)] bg-[radial-gradient(circle_at_8%_0%,var(--cm-blue-12),transparent_46%),radial-gradient(circle_at_94%_100%,var(--cm-amber-8),transparent_40%),var(--cm-card-88-white)] px-4 py-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.6),0_18px_40px_-22px_rgba(23,23,23,0.18)] lg:mt-5 lg:block lg:rounded-[24px] lg:px-5 lg:shadow-[inset_0_1px_0_rgba(255,255,255,0.6),0_1px_2px_rgba(23,23,23,0.03),0_22px_48px_-24px_rgba(23,23,23,0.18)]",
            ...
            {activeTab === "videos" && (
              <div className="mt-3 rounded-[22px] border border-[var(--cm-line-80)] bg-[radial-gradient(circle_at_92%_0%,var(--cm-amber-14),transparent_46%),radial-gradient(circle_at_6%_100%,var(--cm-blue-10),transparent_42%),var(--cm-card-88-white)] p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.6),0_18px_40px_-22px_rgba(23,23,23,0.18)] lg:hidden">
                <SidebarPlaylist {...commonSidebarProps} />
              </div>
            )}
          </div>
          <div className="hidden lg:col-span-4 lg:flex lg:flex-col lg:gap-4">
            <aside className="lg:flex lg:flex-col lg:gap-0 lg:overflow-y-auto rounded-[24px] border border-[var(--cm-line-80)] bg-[radial-gradient(circle_at_92%_0%,var(--cm-amber-14),transparent_46%),radial-gradient(circle_at_6%_100%,var(--cm-blue-10),transparent_42%),var(--cm-card-88-white)] p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.6),0_1px_2px_rgba(23,23,23,0.03),0_24px_50px_-26px_rgba(23,23,23,0.2)]">
