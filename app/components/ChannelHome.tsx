  ...
  if (!selectedVideo)
    return (
      <main className="min-h-screen flex items-center justify-center p-6 bg-[var(--chan-nav)]">
        <div className="max-w-md w-full rounded-[var(--chan-radius-xl)] border border-[var(--chan-line)] bg-white p-10 text-center animate-in fade-in zoom-in duration-500">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center h-[44px] px-10 rounded-[var(--chan-radius-md)] bg-[#2563EB] text-white font-brand font-bold text-[14px] transition-all active:scale-95 hover:-translate-y-px"
          >
      ...
      <div className="mx-auto max-w-[1180px] px-4 pb-8 pt-4 md:px-6 lg:px-8 lg:pb-10 lg:pt-5">
        <div className="grid grid-cols-12 gap-5 lg:items-start xl:gap-6">
          <div className="col-span-12 flex flex-col lg:col-span-8">
            ...
            {isDesktop ? (
              <div className="mt-5 hidden rounded-[var(--chan-radius-xl)] border border-[var(--chan-line)] bg-[color-mix(in_srgb,var(--chan-card)_84%,white)] px-5 py-2 shadow-[var(--chan-shadow-md)] lg:block">
                {mounted ? comments : <CommentsMountPlaceholder />}
              </div>
            ) : mounted ? (
              <>
                <div className="mt-5 lg:hidden">
                  <div className="relative flex overflow-hidden rounded-[var(--chan-radius-lg)] border border-[var(--chan-line)] bg-[color-mix(in_srgb,var(--chan-card)_86%,white)] p-1 font-sans shadow-[var(--chan-shadow-sm)]">
                    {(["comments", "videos"] as const).map((tab) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            "relative flex-1 rounded-[var(--chan-radius-md)] py-2.5 text-[12px] font-bold not-italic uppercase tracking-widest transition-all duration-200",
                            isActive
                ...
                <div className="mt-3 lg:hidden">
                  {activeTab === "comments" ? (
                    <div className="rounded-[var(--chan-radius-xl)] border border-[var(--chan-line)] bg-[color-mix(in_srgb,var(--chan-card)_86%,white)] px-4 py-2 shadow-[var(--chan-shadow-md)]">{comments}</div>
                  ) : (
                    <div className="rounded-[var(--chan-radius-xl)] border border-[var(--chan-line)] bg-[color-mix(in_srgb,var(--chan-card)_84%,white)] p-3 shadow-[var(--chan-shadow-md)]">
          ...
          <div className="hidden lg:col-span-4 lg:flex lg:flex-col lg:gap-4">
            <aside className="lg:flex lg:flex-col lg:gap-0 lg:overflow-y-auto rounded-[var(--chan-radius-xl)] border border-[var(--chan-line)] bg-[color-mix(in_srgb,var(--chan-card)_82%,white)] p-3 shadow-[var(--chan-shadow-lg)]">
