  ...
  if (!selectedVideo)
    return (
      <main className="min-h-screen flex items-center justify-center p-6 bg-[var(--chan-nav)]">
        <div className="max-w-md w-full rounded-[12px] border border-[var(--chan-line)] bg-white p-10 text-center shadow-[var(--chan-shadow-card)] animate-in fade-in zoom-in duration-500">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center h-[44px] px-10 rounded-[8px] bg-[#2563EB] text-white font-brand font-bold text-[14px] transition-colors hover:bg-[#1d4ed8]"
          >
      ...
      <div className="mx-auto max-w-[1180px] px-4 pb-8 pt-4 md:px-6 lg:px-8 lg:pb-10 lg:pt-5">
        <div className="grid grid-cols-12 gap-5 lg:items-start xl:gap-6">
          <div className="col-span-12 flex flex-col lg:col-span-8">
            ...
            {isDesktop ? (
              <div className="mt-5 hidden rounded-[12px] border border-[var(--chan-line)] bg-white px-5 py-2 shadow-[var(--chan-shadow-card)] lg:block">
                {mounted ? comments : <CommentsMountPlaceholder />}
              </div>
            ) : mounted ? (
              <>
                <div className="mt-5 lg:hidden">
                  <div className="relative flex overflow-hidden rounded-[8px] border border-[var(--chan-line)] bg-white p-1 font-sans shadow-[var(--chan-shadow-card)]">
                    {(["comments", "videos"] as const).map((tab) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            "relative flex-1 rounded-[6px] py-2.5 text-[12px] font-bold not-italic uppercase tracking-widest transition-all duration-200",
                            isActive
                ...
                <div className="mt-3 lg:hidden">
                  {activeTab === "comments" ? (
                    <div className="rounded-[12px] border border-[var(--chan-line)] bg-white px-4 py-2 shadow-[var(--chan-shadow-card)]">{comments}</div>
                  ) : (
                    <div className="rounded-[12px] border border-[var(--chan-line)] bg-white p-3 shadow-[var(--chan-shadow-card)]">
          ...
          <div className="hidden lg:col-span-4 lg:flex lg:flex-col lg:gap-4">
            <aside className="lg:flex lg:flex-col lg:gap-0 lg:overflow-y-auto rounded-[12px] border border-[var(--chan-line)] bg-white p-3 shadow-[var(--chan-shadow-card)]">
