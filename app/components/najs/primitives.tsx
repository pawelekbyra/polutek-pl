...
export function NajsIcon({
  ...
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true">
      ...
      {name === "bell" && <><path d="M9 4.5 L9 4 M15 4.5 L15 4" {...c} /><path d="M12 3 C9 3 7 5.5 7 8 v4 l-1.5 2 h19 l-1.5 -2 v-4 c0 -2.5 -2 -5 -5 -5 Z" {...c} /><circle cx="12" cy="20" r="0.8" fill={stroke} stroke="none" /></>}
      ...
      {name === "copy" && <><rect x="9" y="9" width="11" height="12" rx="2" {...c} /><path d="M15 9 V6.5 A2 2 0 0 0 13 4.5 H6 A2 2 0 0 0 4 6.5 V16 A2 2 0 0 0 6 18 H9" {...c} /></>}
    </svg>
  );
}