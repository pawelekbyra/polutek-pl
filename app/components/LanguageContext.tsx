...
export const translations = {
  pl: {
    ...
    donationDescription: 'Wsparcie od widzów pomaga rozwijać serwis www.pawelperfect.pl i tworzyć kolejne materiały. W podziękowaniu otrzymujesz dostęp do Strefy Fenkju.',
  ...
  en: {
    ...
    donationDescription: "Viewer support helps develop www.pawelperfect.pl and create new content. As a thank-you, you receive access to the Thank You Zone.",
