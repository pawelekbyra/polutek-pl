...
export const translations = {
  pl: {
    ...
    donationDescription: 'Wpłaty od widzów pomogą szybko rozwijać kanał\ni tworzyć kolejne materiały. W podziękowaniu za napiwek zapraszam do Strefy Fenju.',
    ...
    pleaseAcceptTerms: 'Zapraszam do Strefy Fenju (zaakceptuj regulamin)',
    tipTheGuy: 'NAPIWKUJ'
  },
  en: {
    views: 'views',
    ...
    donationDescription: "Viewer contributions will help rapidly grow the channel \nand create new content. As a thank you for your tip, I invite you to the Thank You Zone.",
    ...
    pleaseAcceptTerms: 'I invite you to the Thank You Zone (please accept terms)',
