...
export const translations = {
  pl: {
    ...
    secretProject: 'Bramka Napiwkowa',
    crowdfundingHeadline: 'Zbieram na mój tajny projekt',
    crowdfundingProgress: 'Postęp',
    crowdfundingDaysLeft: 'dni do końca',
    crowdfundingAmount: 'Dorzuć do projektu',
    crowdfundingButton: 'WESPRZYJ PROJEKT',
    ...
    confirmUnsubscribeTitle: 'CZY CHCESZ SIĘ WYPISAĆ?',
    confirmUnsubscribeText: 'Wypisanie wyłącza powiadomienia mailowe o nowościach. Nie wpływa na status Patrona ani dostęp do materiałów.',
    yes: 'TAK',
    no: 'NIE',
  ...
  en: {
    ...
    secretProject: 'tippping gate',
    crowdfundingHeadline: 'I rise money for my secret project',
    crowdfundingProgress: 'Progress',
    crowdfundingDaysLeft: 'days left',
    crowdfundingAmount: 'Add to project',
    crowdfundingButton: 'SUPPORT PROJECT',
    ...
    confirmUnsubscribeTitle: 'DO YOU WANT TO UNSUBSCRIBE?',
    confirmUnsubscribeText: 'Unsubscribing turns off email notifications about news. It does not affect Patron status or access to materials.',
    yes: 'YES',
    no: 'NO',
