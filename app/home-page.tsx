...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `${baseUrl}${getLocalizedHref('pl', 'home')}`,
      languages: {
        pl: `${baseUrl}${getLocalizedHref('pl', 'home')}`,
        en: `${baseUrl}${getLocalizedHref('en', 'home')}`,
        'x-default': `${baseUrl}${getLocalizedHref('pl', 'home')}`,
      },
    },
    openGraph: {
...
export default async function HomePage({ locale, searchParams }: { locale: Locale; searchParams: { v?: string; q?: string } }) {
