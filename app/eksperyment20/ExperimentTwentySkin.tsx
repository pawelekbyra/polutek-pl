...
export default function ExperimentTwentySkin({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="experiment20-skin">
      <div className="exp20-poster" aria-hidden="true">
        <span className="disc" />
        <span className="bar" />
        <span className="pillar" />
      </div>
      <section className="exp20-stage" aria-label="Eksperyment 20 — bauhaus bez czerwieni">
        <div className="exp20-caption" aria-hidden="true">
          <b>POLUTEK</b>
          <span>layout system 20</span>
        </div>
        {children}
      </section>
      ...
      <style jsx global>{`
        .experiment20-skin {
          ...
          background:
            ...
            radial-gradient(circle at 6% 12%, rgba(30,143,106,.26), transparent 24vw),
        ...
        .experiment20-skin *,
        .experiment20-skin *::before,
        .experiment20-skin *::after {
        ...
        .exp20-stage .bg-neutral-50,
        .exp20-stage .bg-white,
        .exp20-stage .bg-background\/80,
        .exp20-stage .bg-secondary {
          background: transparent !important;
        }

        .exp20-stage .text-neutral-900,
        .exp20-stage .text-foreground,
        .exp20-stage .text-black,
        .exp20-stage h1,
        .exp20-stage h2,
        .exp20-stage h3,
        .exp20-stage strong {
        ...
        .exp20-stage .text-neutral-700,
        .exp20-stage .text-neutral-600,
        .exp20-stage .text-muted-foreground,
        .exp20-stage p,
        .exp20-stage span {
          color: var(--ink-soft);
        }
        ...
        .exp20-stage .border,
        .exp20-stage .border-border,
        .exp20-stage .border-input,
        .exp20-stage .border-neutral-100,
        .exp20-stage .border-neutral-200,
        .exp20-stage .border-neutral-300 {
          border-color: var(--ink) !important;
        }

        .exp20-stage [class*="shadow"] {
          box-shadow: 8px 8px 0 rgba(16,16,16,.16) !important;
        }

        .exp20-stage input,
        .exp20-stage textarea {
          color: var(--ink) !important;
        ...
        .exp20-stage input:focus,
        .exp20-stage textarea:focus {
          outline: none !important;
          box-shadow: 5px 5px 0 var(--green), 0 0 0 4px rgba(244,197,66,.35) !important;
        }

        .exp20-stage section.bg-transparent {
          position: relative;
          z-index: 2;
        }

        .exp20-stage section.bg-transparent::before {
        ...
        .exp20-stage section.bg-transparent > div > div.relative.aspect-video {
          ...
          box-shadow: 14px 14px 0 var(--green), 28px 28px 0 rgba(16,16,16,.13) !important;
        }

        .exp20-stage section.bg-transparent > div > div.relative.aspect-video::after {
          content: "";
          position: absolute;
          inset: 0;
          z-index: 30;
        ...
        .exp20-stage section.bg-transparent h1 {
          ...
          text-transform: uppercase;
          text-shadow: 4px 4px 0 var(--yellow), 8px 8px 0 rgba(34,89,214,.22);
        }

        .exp20-stage section.bg-transparent div[class*="rounded-[14px]"] {
          position: relative;
          border: 3px solid var(--ink) !important;
          border-radius: 0 !important;
        ...
        .exp20-stage section.bg-transparent div[class*="rounded-[14px]"]:nth-of-type(odd) {
          box-shadow: 8px 8px 0 rgba(30,143,106,.26) !important;
        }

        .exp20-stage section.bg-transparent a[href^="/channel/"] {
          border: 3px solid var(--ink) !important;
          border-radius: 0 !important;
        ...
        .exp20-stage section.bg-transparent a[href^="/channel/"] img {
          border-radius: 0 !important;
          filter: saturate(1.08) contrast(1.06);
        }

        .exp20-stage button[class*="rounded-full"],
        .exp20-stage a[class*="rounded-full"],
        .exp20-stage div[class*="rounded-full"] {
          border-radius: 0 !important;
        }
        ...
        .exp20-stage button[class*="bg-[#171717]"]:hover,
        .exp20-stage aside button.w-full:hover,
        .exp20-stage aside button[class*="bg-primary"]:hover {
          transform: translate(-2px, -2px);
          box-shadow: 9px 9px 0 var(--ink) !important;
        }

        .exp20-stage [class*="bg-black/62"] {
        ...
        .exp20-stage aside a[href^="/?v="]:nth-of-type(3n+1) {
          box-shadow: 7px 7px 0 var(--yellow) !important;
        }

        .exp20-stage aside a[href^="/?v="]:nth-of-type(3n+2) {
          box-shadow: 7px 7px 0 rgba(30,143,106,.72) !important;
        }

        .exp20-stage aside a[href^="/?v="]:hover {
          transform: translate(-2px, -2px) rotate(-.4deg);
          box-shadow: 11px 11px 0 var(--ink) !important;
        }

        .exp20-stage aside a[aria-current="page"] {
          background: var(--yellow) !important;
          box-shadow: 9px 9px 0 var(--blue) !important;
        }

        .exp20-stage aside a[href^="/?v="] > div:first-child {
          border-radius: 0 !important;
          border-color: var(--ink) !important;
          filter: saturate(1.05) contrast(1.08);
        }

        .exp20-stage aside a[href^="/?v="] > div:first-child::after {
          content: "";
          position: absolute;
          inset: 0;
          z-index: 22;
        ...
        .exp20-stage div[class*="rounded-[16px]"],
        .exp20-stage div[class*="rounded-2xl"],
        ...
        @media (max-width: 768px) {
          ...
          .exp20-stage section.bg-transparent > div > div.relative.aspect-video {
            box-shadow: 8px 8px 0 var(--green) !important;
          }
        }
      `}</style>
    </div>
