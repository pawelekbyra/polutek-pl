...
// Frijole powers the wordmark logo. The woff2 (latin subset — the logo is
// ASCII-only) is committed under app/fonts/ (OFL license alongside it), so the
// build self-hosts it and never reaches out to a remote font provider.
export const brandLogoFont = localFont({
  src: "./fonts/frijole-latin.woff2",
  weight: "400",
  style: "normal",
  display: "swap",
