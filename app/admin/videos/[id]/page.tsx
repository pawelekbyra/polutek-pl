...
export default function VideoDetailsPage(props: { params: Promise<{ id: string }> }) {
    ...
    if (error || !video) return (<div className="min-h-screen bg-muted/20 text-foreground"><Navbar /><main className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8 text-center py-20"><AdminNavigation items={[{ label: "Admin", href: "/admin" }, { label: "Filmy", href: "/admin/videos" }, { label: "Szczegóły", href: `/admin/videos/${params.id}` }]} backHref="/admin/videos" backLabel="Wróć do filmów" className="mb-6 flex flex-col items-center" /><div className="text-destructive font-bold text-xl mb-4">{error || "Film nie znaleziony."}</div></main></div>);
        ...
        <main className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
              <div className="flex flex-col gap-1">
                  <AdminNavigation
                    items={[{ label: "Admin", href: "/admin" }, { label: "Filmy", href: "/admin/videos" }, { label: "Szczegóły", href: `/admin/videos/${video.id}` }]}
