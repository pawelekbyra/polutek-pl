...
export default function UserDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-muted/40 via-background to-background text-foreground">
      <Navbar />
      <main className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <AdminNavigation backHref="/admin/users" backLabel="Wróć do listy użytkowników" currentLabel="Dashboard użytkowników" breadcrumbs={[{ href: "/admin/users", label: "Użytkownicy" }]} />
