...
export default function UserDetailsPage(props: { params: Promise<{ userId: string }> }) {
    ...
    if (error || !user) {
      return (
        <div className="min-h-screen bg-gradient-to-b from-muted/40 via-background to-background text-foreground">
          <Navbar />
          <main className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            <AdminNavigation backHref="/admin/users" backLabel="Wróć do listy użytkowników" currentLabel="Szczegóły użytkownika" breadcrumbs={[{ href: "/admin/users", label: "Użytkownicy" }]} />
