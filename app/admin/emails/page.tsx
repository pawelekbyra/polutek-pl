...
export default function AdminEmailsPage() {
  ...
  const [broadcastHistoryRefreshToken, setBroadcastHistoryRefreshToken] =
    useState(0);
  const [settingsStatus, setSettingsStatus] =
    useState<EmailSettingsStatus | null>(null);
    ...
    <div className="min-h-screen bg-neutral-50 text-foreground pb-20">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        <header className="mb-12">
          <h1 className="text-4xl font-black uppercase tracking-tighter text-neutral-900 mb-2">
            Poczta Admina
          </h1>
          <p className="text-neutral-500 font-medium italic">
            Zarządzanie komunikacją, szablonami i odpowiedziami od użytkowników.
          </p>
        </header>
        ...
        {editingTemplate ? (
          ...
          >
            <TabsList className="bg-white border border-neutral-200 p-1 h-14 rounded-2xl shadow-sm inline-flex mb-8 overflow-x-auto max-w-full no-scrollbar">
              <TabsTrigger
                value="dashboard"
                className="rounded-xl px-6 font-black uppercase tracking-widest text-[10px] flex items-center gap-2"
              >
              ...
              <TabsTrigger
                value="broadcast"
                className="rounded-xl px-6 font-black uppercase tracking-widest text-[10px] flex items-center gap-2 bg-blue-50 text-blue-700 data-[state=active]:bg-blue-600 data-[state=active]:text-white"
              >
              ...
              <div className="max-w-2xl mx-auto py-12 text-center space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-neutral-500 italic">
                    Przygotuj i wyślij wiadomość do swoich subskrybentów lub
                    patronów.
                  </p>
                </div>
                <Button
                  onClick={() => setIsCreatingBroadcast(true)}
                  className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl px-12 h-14 font-black uppercase tracking-widest shadow-xl transition-all"
                >
                  Rozpocznij kreator
                </Button>
              </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-xs text-neutral-500 italic">
                    Panel pokazuje wyłącznie bezpieczny status konfiguracji. Nie
                    ujawnia wartości zmiennych środowiskowych ani sekretów.
                  </p>
                </CardContent>
              </Card>
            </TabsContent>
