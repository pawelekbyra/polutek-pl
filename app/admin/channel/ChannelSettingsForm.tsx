  ...
  if (!creator) {
    return (
      <main className="mx-auto w-full max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        <AdminNavigation
          items={[{ label: "Admin", href: "/admin" }, { label: "Kanał", href: "/admin/channel" }]}
          backHref="/admin"
                      ...
                      onClick={async () => {
                        ...
                        try {
                          ...
                          if (res.ok) {
                            ...
                            const updated = (data.updated as Array<{ creatorId: string; subscribersCount: number }>).find((c) => c.creatorId === creator.id);
                            if (updated) {
