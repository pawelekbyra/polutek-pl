      ...
      <main className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-md prose-neutral leading-relaxed space-y-8">
          <section>
            ...
            <p>
              Dla bezpieczeństwa i wygody użytkowników, POLUTEK.COM korzysta z zewnętrznego systemu uwierzytelniania <strong>Clerk</strong>.
          ...
          <section>
            ...
            <p>
              ...
              bezpiecznych płatności online. POLUTEK.COM nie przechowuje ani nie ma bezpośredniego dostępu do danych kart płatniczych
          ...
          <section>
            ...
            <p>
              Strona POLUTEK.COM wykorzystuje niezbędne pliki cookies do utrzymania sesji użytkownika oraz zapewnienia bezpieczeństwa.
