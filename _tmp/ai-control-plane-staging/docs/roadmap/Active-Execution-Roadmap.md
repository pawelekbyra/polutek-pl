...
`AGENTS.template.md` jest przyszłą treścią root `AGENTS.md`; w stagingu nie istnieje plik `AGENTS.md`, aby nie aktywować instrukcji przed Integrator activation PR.
