# AGENTS.template.md — przyszły root AGENTS.md
...
`AGENTS.template.md` jest przyszłą treścią root `AGENTS.md`. Celowo nie nazywa się `AGENTS.md` w stagingu, żeby nie był traktowany jako aktywne instrukcje agentów przed aktywacją. W przyszłym Integrator activation PR należy skopiować/zmienić nazwę: `_tmp/ai-control-plane-staging/AGENTS.template.md` -> `AGENTS.md`.
