...
- `AGENTS.template.md` — przyszła treść root `AGENTS.md`; nie jest aktywnym `AGENTS.md` w stagingu.
...
Podczas przyszłego Integrator activation PR należy skopiować/zmienić nazwę `_tmp/ai-control-plane-staging/AGENTS.template.md` -> `AGENTS.md`. Plik jest template, żeby staging nie narzucał aktywnych instrukcji przed aktywacją.
