...
<!-- CONTROL_PLANE_CURRENT_TICKET_ID: EMAIL-SIGNED-UNSUBSCRIBE-001 -->
<!-- CONTROL_PLANE_CURRENT_TICKET_FILE: docs/tickets/ready/EMAIL-SIGNED-UNSUBSCRIBE-001.md -->
...
```txt
EMAIL-SIGNED-UNSUBSCRIBE-001
```

| Role | Ticket | File | Status |
| --- | --- | --- | --- |
| Builder | EMAIL-SIGNED-UNSUBSCRIBE-001 | `docs/tickets/ready/EMAIL-SIGNED-UNSUBSCRIBE-001.md` | `READY_FOR_BUILDER` |

**Current Status:** PR #916 independently verified `EMAIL-WEBHOOK-SVIX-POSTMERGE-VERIFY-001` with verdict `PASS` and merged under SHA `62548c01cf2df66b88d608ebc751e68871b0ff3d`. PR #914 implemented `EMAIL-WEBHOOK-SVIX-PRODUCTION-REPAIR-001` and is now `MERGED / IMPLEMENTATION_COMPLETE / VERIFIED_PASS / HISTORICAL`. The next executable task is the Builder ticket for secure signed logged-out unsubscribe.
