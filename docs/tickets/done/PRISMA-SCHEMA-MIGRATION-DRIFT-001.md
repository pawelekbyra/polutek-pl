Status: DONE — resolved by PR #1503 (merged to `main`, commit `f90c481`).

See `docs/audit/2026-09-26-prisma-migration-drift-and-timestamp-audit.md` for
the verification writeup (clean-DB replay + diff, confirmed zero drift after
the three additive migrations this ticket's fix landed in).
