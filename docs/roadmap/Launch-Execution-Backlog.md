...
| 3 | Signed unsubscribe | EMAIL-SIGNED-UNSUBSCRIBE-001 / IMPLEMENTED / VERIFICATION_PENDING | Email consent boundary | Reviewer / Certifier | None for this verification | Implementation PR #918; implementation merge SHA `5710d14f82f5951c13d8d77f6a8eb4d899068c4b`; verification ticket `EMAIL-SIGNED-UNSUBSCRIBE-POSTMERGE-VERIFY-001` | Compliance blocker pending independent verification |
