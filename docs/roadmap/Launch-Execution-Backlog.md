...
| 4 | Bounce/complaint suppression | EMAIL-BOUNCE-COMPLAINT-SUPPRESSION-001 / READY VIA CANONICAL QUEUE | Email consent boundary and signed unsubscribe separation | Builder + operator | Provider access/evidence | Provider events, durable local suppression, no automatic re-opt-in, deliverability evidence | Compliance blocker; public launch remains NO_GO |
