...
- Lane ID: `cleanup-legacy`
- Primary phase: X0
- Goal: usunąć legacy glue, stale allowlists, stale audits i dead-code dopiero po inventory
- Parallel safety: CAUTION / SERIAL for global docs
