...
| AccessPolicy decommissioning | `2026-06-23-access-policy-decommissioning.md` | PR #1075 removed the legacy runtime surface; issue #1036 received post-#1079 closure evidence for broader patron-cache/UI metadata cleanup. |
